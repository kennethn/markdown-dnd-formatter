#!/bin/bash
# content-transformer-complete.sh - Complete content transformation with ALL original functionality

source "$(dirname "${BASH_SOURCE[0]}")/common.sh"

# =========================
# Complete Content Transformation (restored from original)
# =========================
...
if (/^__BODY_LINE__/) {
  ...
  # Encounter, image, remember, and music boxes
  s/^\*\*(Encounter:.*)\*\*/$1/;
  s/^\*\*(Image:.*)\*\*/$1/;
  s/^\*\*(Show image:.*)\*\*/$1/;
  s/^\*\*(Remember:.*)\*\*/$1/;
