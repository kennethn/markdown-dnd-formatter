...
\definecolor{keywordcolor}{HTML}{30638E}     % Keyword highlighting
\definecolor{highlightcolor}{HTML}{ebf8ff}   % Light blue background
\definecolor{highlightborder}{HTML}{30638E}  % Border for highlights
\definecolor{tableheadercolor}{HTML}{30638E} % Table header background

% Callout box colors
\definecolor{encountercolor}{HTML}{A32939}   % Red for encounters
\definecolor{encounterborder}{HTML}{ffffff}  % White borders
\definecolor{monstercolor}{HTML}{A32939}     % Red for monster blocks
\definecolor{imagecolor}{HTML}{30638e}       % Blue for images
\definecolor{imageborder}{HTML}{ffffff}      % White borders
\definecolor{remembercolor}{HTML}{edae49}    % Yellow for reminders
\definecolor{rememberborder}{HTML}{000000}   % Black borders
\definecolor{musiccolor}{HTML}{06D6A0}       % Green for music
