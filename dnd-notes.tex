...
\definecolor{sectioncolor}{HTML}{0b4778}      
\definecolor{keywordcolor}{HTML}{fff1d2}
\definecolor{highlightcolor}{HTML}{f6f6f6}
\definecolor{highlightborder}{HTML}{0076d6}
\definecolor{encountercolor}{HTML}{ffe2d1}
\definecolor{encounterborder}{HTML}{ff580a}
\definecolor{monstercolor}{HTML}{b50909}
\definecolor{imagecolor}{HTML}{cfe8ff}
\definecolor{imageborder}{HTML}{0076d6}
\definecolor{remembercolor}{HTML}{ffe396}
\definecolor{rememberborder}{HTML}{e5a000}
...
\fancyhf{}
\fancyfoot[LE,RO]{\color{sectioncolor}\thepage}
...
\renewcommand{\footrule}{
  \color{sectioncolor} \hrule \@height 0.5pt \@width \headwidth \vskip2pt
}
\makeatother
\pagestyle{fancy}
