...
% Main document font
\setmainfont{Public Sans}[Ligatures=TeX]

% Specialized font families
\newfontfamily\blockquoteFont{Public Sans}[
  Ligatures=TeX,
  BoldFont={Public Sans SemiBold},
  BoldItalicFont={Public Sans SemiBold Italic},
  Scale=0.9
]

\newfontfamily\headerfontbold{Public Sans Bold}[Ligatures=TeX]
\newfontfamily\headerfont{Public Sans SemiBold}[Ligatures=TeX]

\newfontfamily\monsterFont{Public Sans}[
  Ligatures=TeX,
  Scale=0.85,
  BoldFont={Public Sans SemiBold},
  BoldItalicFont={Public Sans SemiBold Italic}
