...
\newfontfamily\headerfont{XCharter}[
  Ligatures=TeX,
  Numbers=Lining,
  Letters=SmallCaps,
  Scale=1.05
...
\usepackage{titlesec}
\titleformat{\section}[block]{\Large\color{sectioncolor}\headerfont}{}
  {0pt}{\stickysection}
\titleformat{\subsection}[block]
  {\large\color{subsectioncolor}\headerfont}
  {}
  {0pt}
  {\stickysubsection}
  [\vspace{2pt}\color{subsectioncolor}\hrule height 1pt]
