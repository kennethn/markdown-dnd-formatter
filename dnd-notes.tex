...
\definecolor{highlightcolor}{HTML}{ebf8ff}
...
\definecolor{musiccolor}{HTML}{06D6A0}
...
% Lists: avoid one-line widows/orphans safely
\makeatletter
\newcommand{\ListWidowControl}{%
  ...
  \interlinepenalty=100 % mild push to break earlier, not mid-line
}
