...
\newfontfamily\monsterFont{Inter}[
  Ligatures=TeX,
  Numbers=Lining, 
  Scale=0.9,
...
\titleformat{\subsubsubsection}[block]
  {\stickysubsubsubsection\subsubsubsectionsize\color{subsubsubsectioncolor}\headerfontbold}
  {}
  {0pt}
  {}
...
\titlespacing*{\subsubsection}{0pt}{8pt plus 1pt minus 1pt}{6pt}
\titlespacing*{\subsubsubsection}{0pt}{8pt plus 1pt minus 1pt}{4pt}
